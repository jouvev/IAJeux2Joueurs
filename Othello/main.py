...
sys.path.append("./Joueurs/tests") 
import joueur_alphabetaSAVE

game.joueur1=joueur_random
game.joueur2=joueur_alphabetaSAVE
...
def joue():
    """ void -> int
        ...
        Hypothèse: Le jeu se finit forcément.
    """
...
def train(eps=0.50, n=100):#decay=0.999
